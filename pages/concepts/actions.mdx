...
*   Bank
    *   [Deposit item](https://api.artifactsmmo.com/docs/#/operations/action_deposit_bank_my__name__action_deposit_post)
    *   [Deposit gold](https://api.artifactsmmo.com/docs/#/operations/action_deposit_bank_gold_my__name__action_deposit_gold_post)
    *   [Withdraw item](https://api.artifactsmmo.com/docs/#/operations/action_withdraw_bank_my__name__action_withdraw_post)
    *   [Withdraw gold](https://api.artifactsmmo.com/docs/#/operations/action_withdraw_bank_gold_my__name__action_withdraw_gold_post)

*   Grand Exchange
    *   [Buy item](https://api.artifactsmmo.com/docs/#/operations/action_ge_buy_item_my__name__action_buy_post)
    *   [Sell item](https://api.artifactsmmo.com/docs/#/operations/action_ge_sell_item_my__name__action_sell_post)
