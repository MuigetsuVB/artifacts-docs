...
NPCs are merchandise characters from whom you can buy or sell items. Some are static, while others appear dynamically through the [event system](/concepts/events).
...
```
[View the API Reference](https://api.artifactsmmo.com/docs/#/operations/get_all_npcs_npcs_get)
...
[View the API Reference](https://api.artifactsmmo.com/docs/#/operations/get_npc_items_npcs__code__items_get)
