...
### Gathering XP Calculation

The XP gained from gathering resources is calculated based on the resource's level:
...
**Penalties:**
- If `player_level - resource_level > 10`: No XP is gained (XP = 0)
...
### Crafting XP Calculation

The base XP gained from crafting is calculated based on the item's level:
...
After calculating the base XP using the formula above, the following multipliers are applied:
- **Gathering skills** (Mining, Woodcutting, Fishing): XP × 0.1 (90% reduction)
- **Cooking**: XP × 0.5 (50% reduction)
- **Other Crafts** (Weaponcrafting, Gearcrafting, Jewelrycrafting, Alchemy): Full XP value (no reduction)
