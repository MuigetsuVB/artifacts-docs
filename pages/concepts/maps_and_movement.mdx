...
You can also view the list of maps [on our website](https://artifactsmmo.com/database/maps) or use [an API request](https://api.artifactsmmo.com/docs/#/operations/get_all_maps_maps__get).
...
* Monster (All monsters: https://artifactsmmo.com/database/monsters)
* Resource (All ressources: https://artifactsmmo.com/database/resources)
* Workshop (All crafts by workshop : https://artifactsmmo.com/database/crafts)
* Bank
* Grand Exchange
* Tasks Master
