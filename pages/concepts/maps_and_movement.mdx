...
You can also view the list of maps [on our website](https://artifactsmmo.com/database/maps) or use [an API request](https://api.artifactsmmo.com/docs/#/operations/all_maps_maps__get).
...
*   Ressource (All ressources: <https://artifactsmmo.com/database/ressources>)
