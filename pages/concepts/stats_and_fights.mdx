...
Damage is also rounded during the calculation process. The damage calculation does not happen all at once.

The formula is: **Round(Attack \* Round(Damage \* 0.01))** for each element.

For example, if a player has a base attack of 100 and damage buffs totaling 35%, the calculation would be:
Round(100 \* Round(35 \* 0.01)) = Round(100 \* 0.35) = Round(35) = 35 damage
