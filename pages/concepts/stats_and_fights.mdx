...
The character with the highest threat in a multi-character fight will be the main target of the monster's attacks.  If there are multiple characters with the same threat level, it targets the one with the lowest HP.
