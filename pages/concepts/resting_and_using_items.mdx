...
For example, the [Cooked Beef](https://www.artifactsmmo.com/encyclopedia/items/cooked_beef/) requires your character to be above level5.
...
This is the POST request you can use to equip an item.
