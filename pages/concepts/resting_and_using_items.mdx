...
You can see the list of items [on our website](https://client-test.artifactsmmo.com/encyclopedia/items?category=consumable) or use [an API request](https://api.artifactsmmo.com/docs/#/operations/get_all_items_items_get).
