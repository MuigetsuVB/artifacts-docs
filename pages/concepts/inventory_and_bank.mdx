...
You can view the contents of your inventory with[ this request.](https://api.artifactsmmo.com/docs/#/operations/my_characters_my_characters_get)
...
curl --request POST \
  --url https://api.artifactsmmo.com/my/{name}/action/withdraw \
...
const url = 'https://api.artifactsmmo.com/my/{name}/action/withdraw';
const options = {
  method: 'POST',
  headers: {
...
```
[View the API Reference](https://api.artifactsmmo.com/docs/#/operations/action_withdraw_bank_my__name__action_withdraw_post)
...
```http filename="cURL" copy
curl --request POST \
  --url https://api.artifactsmmo.com/my/{name}/action/deposit \
  --header 'Accept: application/json' \
  --header 'Authorization: Bearer INSERT_YOUR_TOKEN_HERE' \
  --header 'Content-Type: application/json' \
  --data '{
...
```
```js filename="Javascript" copy
const url = 'https://api.artifactsmmo.com/my/{name}/action/deposit';
const options = {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
...
[View the API Reference](https://api.artifactsmmo.com/docs/#/operations/action_deposit_bank_my__name__action_deposit_post)
...
```http filename="cURL" copy
curl --request POST \
  --url https://api.artifactsmmo.com/my/{name}/action/withdraw/gold \
  --header 'Accept: application/json' \
  --header 'Authorization: Bearer INSERT_YOUR_TOKEN_HERE' \
  --header 'Content-Type: application/json' \
  --data '{
...
```
```js filename="Javascript" copy
const url = 'https://api.artifactsmmo.com/my/{name}/action/withdraw/gold';
const options = {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
...
```
[View the API Reference](https://api.artifactsmmo.com/docs/#/operations/action_withdraw_bank_gold_my__name__action_withdraw_gold_post)
...
```http filename="cURL" copy
curl --request POST \
  --url https://api.artifactsmmo.com/my/{name}/action/deposit/gold \
  --header 'Accept: application/json' \
  --header 'Authorization: Bearer INSERT_YOUR_TOKEN_HERE' \
  --header 'Content-Type: application/json' \
  --data '{
...
```
```js filename="Javascript" copy
const url = 'https://api.artifactsmmo.com/my/{name}/action/deposit/gold';
const options = {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
...
[View the API Reference](https://api.artifactsmmo.com/docs/#/operations/action_deposit_bank_gold_my__name__action_deposit_gold_post)