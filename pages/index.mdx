...
To share your projects, ask questions, or give feedback, we have a [Discord](https://discord.gg/prEBQ8a6Vs). 
 ...
 ## Season 3 begins on November 9

![New season](https://i.ibb.co/ZM48L6S/idee8.png)

The new season of Artifacts will be available November 9 at 12pm (EST time).

This season will include new features:
- **Hit point management:** Characters will now need to recover lost hit points between fights. This can be done in two ways: by sitting (long cooldown) or by consuming food.
- **New skill: Alchemy :** Potions will be utilities usable in combat (replacing current consumables).
- **New Grand Exchange system**: Place sales orders to sell your items at the price you want to other players. No more automatic buying and selling on the server!
- **Over 80 new items** : Including dozens of new weapons and equipment
- 6 news monsters, 2 new resource and a reworked map.
...
The Alpha 3 is now available with the following features:

- Elemental combat system (fire, air, water, earth)
- 40 levels of combat and skills.
- 8 skills (Mining, Woodcutting, Cooking, Gearcrafting, Weaponcrafting, Jewelrycrafting, Alchemy)
...
In terms of numbers, this represents **over 300 items, +30 monsters, +150 crafts and 357 maps**.
