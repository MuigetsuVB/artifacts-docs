...
# Overview
 ...
 Arifacts is a Sandbox MMORPG  with HTTP endpoints for automating gameplay and building custom tools. Every action you can make with your character is an endpoint you can hit with code.
...
Artifacts is a Sandbox MMORPG where you can do whatever you want - there's no set path to follow.  You can send your characters into combat against monsters, obtain resources through harvesting skills such as mining and wooducting, craft equipment, complete quests and much more.
...
To learn more about the game, check out our  [gameplay  concepts](https://docs.artifactsmmo.com/concepts/actions), or try the game with our  [quickstart](https://docs.spacetraders.io/quickstart/new-game)  guide.

The game is currently in alpha and  under active development, so we are always adding new features and content.

## Features

The Alpha 1 will be available in summer 2024 with the following features:
...
In terms of numbers, this represents **over 120 items, +20 monsters, +80 crafts and 255 maps**.
...
We have lots of ideas for the future, and a roadmap for the game's future will be published after the Alpha launch.
