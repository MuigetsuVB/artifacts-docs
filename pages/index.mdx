...
To share your projects, ask questions, or give feedback, we have a [Discord](https://discord.gg/prEBQ8a6Vs). 
 ...
 ## Season 5 is now avaliable

![New season](https://artifactsmmo.com/images/docs/season_msg_s5.png)

This season will include new features:
- **NPC Traders:**  New NPCs will populate the world of Artifacts, offering you opportunities to trade items!
- **New events** : Corruption has invaded the world of Artifacts and is affecting many monsters.
- **Item/Gold Transfers**: Item and gold transfer between same account characters.
- **Condition System:** A new item conditions system. Tools will now require skill levels instead of combat levels.
- **New content! Over 40 new items, 4 new monsters and more!**.

You can check [the patch notes](https://docs.artifactsmmo.com/resources/updates) to see all the new features:
