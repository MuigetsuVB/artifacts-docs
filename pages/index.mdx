...
# Overview
 ...
 Arifacts is a Sandbox MMORPG with HTTP endpoints to automate gameplay and build your own tools. Every action you can perform with your character corresponds to an endpoint that you can interact with using code.
