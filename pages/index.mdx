...
- **New skill: Alchemy :** Gather plants and make potions that you can use in combat (replacing current consumables).
...
- **Over 100 new items** : Including dozens of new weapons and equipment.
- **6 new monsters, 5 new resource and a reworked map**.
