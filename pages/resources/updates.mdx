## Update 04/10/25: Season 6  (Preliminary)
...
Some elements are missing in this preliminary version, which will be added in the coming weeks.

- Mithril and Adamantite Tools (note: Level 40 Mithril tools will not have task resources, which will make reaching level 50 easier.)
- Season 6 Achievements
- Season 6 Badges
- Icons of the new runes
- New websockets notifications
- Interface for multi-characters fights on the web client.
- Some maps design (coastline) need to be updated.
- New notifications for the websockets server
