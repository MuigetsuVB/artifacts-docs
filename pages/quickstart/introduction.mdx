...
Artifacts uses a **seasonal server system**, with each season lasting **4 months**. Each season brings its own new features, and gives you the chance to stand out from the crowd by being the first player to complete all the achievements and earn a unique badge.
...
The first step is to [create your account](https://artifactsmmo.com/account/register) and your first character [by logging in](https://artifactsmmo.com/my/characters).
After that you'll need your token, which you can find [on your account](https://artifactsmmo.com/my).
 
![Token](https://artifactsmmo.com/images/docs/token.png)
...
You can now open the game client by [clicking here](https://client.artifactsmmo.com). 
