...
![tree](https://api.artifactsmmo.com/images/docs/ash_tree1.png)

If you click on **Ash Wood**, you'll be able to see all the crafts you can do with it.

![tree2](https://api.artifactsmmo.com/images/docs/ash_tree2.png)
...
In the response, you'll see that you've gathered 1 wood for each request. You'll need to repeat the action another time to have **the 2 woods needed in the craft**. You can see the contents of your inventory directly in the response.
