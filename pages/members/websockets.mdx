...
message = {
        "token": token,
        "subscriptions": ["event_spawn", "event_removed", "grandexchange_sell_order", "grandexchange_sell", "achievement_unlocked", "test"]
    }    
```
...
const message = {
    token: token,
    subscriptions: ["event_new", "grandexchange_sell", "grandexchange_sell_order"]
};
...
public class WebSocketHandler extends WebSocketClient {
    ...
    public void onOpen(ServerHandshake handshakedata) {
        String message = """
        {"token": "%s",
        "subscriptions": ["event_spawn", "event_removed,"grandexchange_sell", "grandexchange_sell_order", "achievement_unlocked"]};
        """.formatted(TOKEN);
        send(message);
