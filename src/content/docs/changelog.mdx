...
import CollapsibleContent from '../../components/site/CollapsibleContent.astro';

## Update 07/19/26: version 8.2.0

Here's the patch notes for version 8.2.0.

**Seasonal event**
- New temporary seasonal event content.
- Added event tickets.

**Event ticket drops**
| Source | Drop rate | Average drop |
|--|--|--|
| Monsters | 1% | 1 every 100 kills |
| Resources | 0.5% | 1 every 200 gatherings |
| Raids | Guaranteed | 1 every 20,000 damage dealt |
...
**Archaeologist shop**
- Lich Race Medal costs 100 event tickets at the Archaeologist.
- Lich Race Trophy costs 10 Lich Race Medals at the Archaeologist.

## Update 07/13/26: version 8.1.0

Here's the patch notes for version 8.1.0.

**Members**
- New endpoint: `POST /my/{name}/action/rename` to change a character's name. This feature is reserved for members.
- Character rename is also available in the UI under the `Customization` button.

## Update 07/06/26: version 8.0.1

Here's the patch notes for version 8.0.1.

**Changes**
- Nomadic Merchant now buys Forest Staff for 100 gold.
- Fish Merchant now buys Lava Fish for 1 gold.
- Herbal Merchant now buys Enchanted Mushroom for 1 gold.
- Events spawned with gems now have a minimum 2-hour cooldown before they can be spawned again.

**WebSockets**
- Added `grandexchange_cancel_sell_order`, sent with `GEOrderSchema` when a sell order is cancelled on the Grand Exchange.
- Added `grandexchange_cancel_buy_order`, sent with `GEOrderSchema` when a buy order is cancelled on the Grand Exchange.

## Update 06/27/26: version 8.0.0

Here's the patch notes for version 8.0.0.

**New content**
- **New monsters:**
  - Full Moon Vampire (Lvl 24)
  - Echoless Bat (Lvl 38)
  - Pixie (Lvl 40)
  - Dryad (Lvl 40)
  - Solar Desert Scorpion (Lvl 50)
  - Baby Red Dragon (Lvl 50)
  - Red Dragon (Lvl 51)
  - Flameche (Lvl 52)
  - Fennec (Lvl 52)
  - Sonnengott (Lvl 55)
...
<CollapsibleContent collapsedHeight="200px" label="Show all new items">

- Small Bag of Gems (Lvl 1)
- Bag of Gems (Lvl 1)
- Forest Staff (Lvl 10)
- Cookie (Lvl 10)
- Raw Porkchop (Lvl 19)
- Cooked Porkchop (Lvl 20)
- Full Moon Vampire Cape (Lvl 24)
- Bat Heart (Lvl 38)
- Echoless Bat Wing (Lvl 38)
- Enchanted Potion (Lvl 40)
- Enchanted Mushroom (Lvl 40)
- Dryad Hair (Lvl 40)
- Enchanted Coin (Lvl 40)
- Enchanted Rune (Lvl 40)
- Diamond Armor (Lvl 40)
- Diamond Skirt (Lvl 40)
- Fennec Tail (Lvl 50)
- Fire Crystal (Lvl 50)
- Fire Dust (Lvl 50)
- Sonnengott Key (Lvl 50)
- Baby Red Dragon Scale (Lvl 50)
- Red Dragon Scale (Lvl 50)
- Dragon Bone (Lvl 50)
- Sonnengott Cloak (Lvl 50)
- Lava Fish (Lvl 50)
- Red Dragon Boots (Lvl 50)
- Red Dragon Legs Armor (Lvl 50)
- Red Dragon Armor (Lvl 50)
- Sandwhisper Potion (Lvl 50)
- Fennec Ear (Lvl 50)
- Solar Desert Scorpion Tail (Lvl 50)
- Powerful Rune (Lvl 50)
- Lava Underground Potion (Lvl 50)
- Medic Armor (Lvl 50)
- Red Dragon Shield (Lvl 50)
- Medic Skirt (Lvl 50)
- Sonnengott Coin (Lvl 55)
...
- **New NPCs:**
  ...
  - Sorceress
- **New map areas:**
  - Underground Lava Area
  - Enchanted Forest Area

**Balance changes**
- **Monster changes:**
  - Cyclops (HP increased, earth and air attacks increased)
  - Owlbear (HP increased, water attack increased)
  - Demon (HP increased, fire attack increased)
  - Corrupted Owlbear (HP increased, water attack increased)
  - Goblin Guard (HP increased, earth attack increased)
  - Orc (HP increased, fire and air attacks increased)
- **Item changes:**
  - Enchanted Fabric (now called Prime Fabric)
  - Enchanted Bow (now caleld Perfect Bow)
  - All Enchanted Potions (Enchanted replaced by enhanced)
  - Recall Potion (level lowered to 5)
  - Forest Bank Potion (level raised to 20)
  - Lifesteal Rune (lifesteal increased from 10 to 15)
  - Greater Lifesteal Rune (lifesteal increased from 20 to 25)
  - Vampiric Rune (vampiric strike increased from 25 to 30)
  - Darkforged Shield (now grants 50 HP)
  - Fried Eggs (Heal reduced to 120 but crafted in sets of 2)
  - Cheese (Heal reduced to 150 but crafted in sets of 2)
  - Mushroom Soup (Heal reduced to 220, but crafted in sets of 2)
  - Apple Pie (Heal reduced to 320, but crafted in sets of 2)
  - Fish Soup (Heal reduced to 500 but crafted in sets of 3)
  - Maple Syrup (Heal reduced to 450, but crafted in sets of 2)
  - Potions are now craftable in batches of 2
  - 79 crafts have been adjusted to incorporate the new resources

**Raids**
- Added scheduled raids: cooperative encounters where all players attack the same boss and reduce a shared HP pool.
- New endpoints:
  - `GET /raids`
  - `GET /raids/{code}`
  - `GET /raids/{code}/leaderboard`
- Added `raid_started` and `raid_ended` for WebSocket notifications.
- Added raid-specific error codes for inactive raids, invalid raid resources, and raid locking.

**Gems, subscriptions, and payments**
- Replaced the previous funding flow with subscriptions and gems.
- Added Stripe checkout support for paid subscriptions and gem packs.
- Added member tokens, which can be redeemed for 30 days of membership.
- New endpoints:
  - `GET /my/subscription`
  ...
  - `GET /my/gems_history`
- Added purchase confirmation emails for subscriptions, gem packs, and Gems Shop purchases.

**Gems Shop**
- Added the Gems Shop catalog and purchases.
- New endpoints:
  - `GET /gems_shop/`
  - `POST /gems_shop/skin`
  - `POST /gems_shop/spawn_event`
  - `POST /gems_shop/subscription`
- Skins, event spawns, and subscription time can now be purchased with gems.
- Event purchases can fail when the event is already active, on cooldown, not purchasable, or when the maximum number of active events is reached.

**Game Assistant**
- Added the member-only Game Assistant.
- New endpoint `POST /game_assistant/ask`.
- Members receive a daily free question limit. When the daily limit is reached, a question can spend 1 gem by sending `pay_with_gems: true`.
- Added `GET /my/rates` to expose current account, data, action, simulation, and assistant rate limits.

**Season rewards**
- Added the new season reward system.
- New endpoints:
  - `GET /season_rewards`
  - `GET /season_rewards/{code}`
- Season rewards can now grant badges, skins, gems, and other rewards based on achievement points.
- Added `season_reward_unlocked` WebSocket notifications.

**Skins**
- Added account skins and character skin changes.
- New public skins endpoints:
  - `GET /skins`
  - `GET /skins/{code}`

**Character stats**
- Added member-only gameplay statistics for characters.
- New endpoint `GET /characters/{name}/stats`.
- Statistics include monsters killed, resources gathered, action counts, and deaths.

**Equipment**
- `POST /my/{name}/action/equip` now accepts a list of items to equip.
- `POST /my/{name}/action/unequip` now accepts a list of slots to unequip.
- Equip and unequip cooldowns are now 3 seconds multiplied by the number of different items processed.
- Utilities can specify quantities when equipped or unequipped.

**Recycling**
- Added enhanced recycling with the `enhanced` payload field.
- Enhanced recycling returns 30% more resources, rounded and capped by the recipe ingredients.
- Enhanced recycling spends gold based on item level and total recipe ingredients.
- Items now expose a `recyclable` field.

**Events**
- Events now support `price`, `cooldown`, and `cooldown_expiration`.
- Events can now be purchased from the Gems Shop when they are marked purchasable.
- Event spawning has been refactored to prevent duplicate active events across workers.

**Sandbox and Beta Server**
- Added sandbox utilities:
  - `POST /sandbox/clear_cooldown`
  - `POST /sandbox/teleport`
- Existing sandbox grant and reset endpoints remain available on sandbox/beta environments.

**Account**
- Added `POST /my/change_email`.
- Account details now include membership, membership expiration, gems, member tokens, badges, and owned skins.

**Bank**
- Bank expansion prices now start at 3,500 gold, double with each purchase, and are capped at 448,000 gold.

**API breaking changes**
- `GET /my/pending-items` has been replaced by `GET /my/pending_items`.
- `POST /simulation/fight_simulation` has been replaced by `POST /simulation/fight`.
- `POST /my/{name}/action/grandexchange/create-buy-order` has been replaced by `POST /my/{name}/action/grandexchange/create_buy_order`.
- `POST /my/{name}/action/grandexchange/create-sell-order` has been replaced by `POST /my/{name}/action/grandexchange/create_sell_order`.
- `POST /events/spawn` has been removed. Use `POST /gems_shop/spawn_event` on the main server, or `POST /sandbox/spawn_event` on sandbox environments.
- `POST /my/{name}/action/equip` now expects an array of equipment objects instead of a single object.
- `POST /my/{name}/action/unequip` now expects an array of unequip objects instead of a single object.

## Update 04/14/26: version 7.0.4

Here's the patch notes for version 7.0.4.

*Move*
- Fixes a bug that occurred when using `map_id` with the `move` action

## Update 03/07/26: version 7.0.3

Here's the patch notes for version 7.0.3.

*NPCs*
- Add the `currency` parameter to the `/npcs/items` endpoint


## Update 02/28/26: version 7.0.2

Here's the patch notes for version 7.0.2.

**Give items/gold**
- Fixed a bug that returned the wrong character in the logs.

**Trade items (Tasks)**
- Fixed the log format, which was inconsistent with other logs.

**Rate limits**
- Added the headers `X-RateLimit-Limit`, `X-RateLimit-Remaining` et `X-RateLimit-Reset` to all API responses to indicate the current rate limits.

**Fight Simulator**
- Added missing error codes on OpenAPI.

**WebSockets**
- Added a `version` notification sent on connection and after each server update.

## Update 02/26/26: version 7.0.1

Here's the patch notes for version 7.0.1.

**Static data**
- Increased the pagination limit to 10,000 on static data endpoints (items, monsters, maps, etc.) to make it easier to retrieve all data in a single request.


## Update 02/21/26: version 7.0.0

Here's the patch notes for Season 7.


**Grand Exchange**
- The Grand Exchange now supports **buy orders** in addition to sell orders. You can now place an order to buy items at a price you choose, and other players can fill your order by selling directly into it.
- New endpoint `POST /my/{name}/action/grandexchange/create-buy-order`: Create a buy order by specifying an item, a quantity (1-100) and a price per unit. The total cost (price × quantity) is locked immediately from your character's gold.
- New endpoint `POST /my/{name}/action/grandexchange/fill`: Sell your items directly into an existing buy order from another player. The gold is credited to you instantly, and the items are delivered to the buyer via the new **pending items** system.
- The sell endpoint has been renamed from `/sell` to `/create-sell-order` for consistency.
- Orders now have a `type` field (`sell` or `buy`) and a unified `account` field instead of separate `seller`/`buyer` fields.

**Pending Items**
- New system for receiving items without needing inventory space right away. Items from various sources (Achievements, Grand Exchange buy orders) are placed in a **pending items queue** tied to your account.
- New endpoint `GET /my/pending-items`: View all your unclaimed pending items.
- New endpoint `POST /my/{name}/action/claim_item/{id}`: Claim a pending item with any character on your account. Items are added to the character's inventory.

**Achievements**
- Achievements now support **multiple objectives**. A single achievement can require you to complete several different tasks (e.g., kill 3 specific monsters AND craft 2 items). Each objective tracks its own progress independently.
- Achievement rewards can now include **items** in addition to gold. Item rewards are delivered through the pending items system and can be claimed by any character on your account.
- New achievement types: `npc_buy` and `npc_sell` — achievements can now track NPC buy/sell actions.

**Sandbox/test**
- New endpoint `POST /sandbox/reset-account`: Reset your account progress on the sandbox server.

**Bank**
- The price of the first bank expansion has been reduced to 4,000 gold.

**Monsters**
- 3 new monsters:
  - Rat: Level 25
  - Goblin Guard: Level 35
  - Goblin Priestess (boss): Level 35
- Resources added to several existing monsters.
- Lich HP reduced from 7200 to 6600.

**Items**
- 18 new items.
- Crafting adjustments to include the new resources.
- Level 40 runes received a small stat upgrade to make them more appealing.

**Fights**
- New effect:
  - Protective Bubble: Grants x% resistance to a random element (fire, earth, water, or air). The element changes at the start of each turn and cannot be the same as the previous one.

**Rest**
- Rest healing has been adjusted to feel smoother and less punishing.
  - **Before:** 1 second per 5 missing HP (minimum 3 seconds)
  - **After**: 1 second per 1% missing HP (minimum 3 seconds)

**Maps**
 - Small update to the map to add:
    - A new house interior at coordinates -3,12
    - A new mine at coordinates 5,-3

**Other Changes**
- New action types in logs: `create_buy_order_ge`, `fill_buy_order_ge`, `claim`.
- Real-time WebSocket notifications for new pending items (`pending_item_received`) and buy order creation (`grandexchange_buy_order`).



## Update 10/15/25: version 6.1.0

Here's the patch notes for the version 6.1.0

**Christmas Event (available until January 11):**
- A new island accessible by boat from 4,16 (overworld)
- 5 new monsters (including one boss)
- 13 new items
- A new event
- A new NPC (Santa Claus exchanges your gifts for items!)


**Outside the event:**
- 2 new items (the new resource will be integrated into crafts during the next season)
- The Nomadic Merchant now buys your sanguine_edge_of_rosen for 6000 gold.
...
**Bank Expansion:**
- The cost of an expansion is now 2500 gold and doubles with each purchase (the price may be adjusted based on beta server data).
