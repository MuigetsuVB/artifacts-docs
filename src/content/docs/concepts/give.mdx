...
- [Inventory & Bank](/concepts/inventory_and_bank/) — Managing items and gold
- [Pending Items](/concepts/pending_items/) — Claiming overflow items
- [Maps & Movement](/concepts/maps_and_movement/) — Characters must be at the same location
