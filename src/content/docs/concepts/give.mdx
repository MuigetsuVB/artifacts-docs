...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_give_items_my__name__action_give_item_post" sdkUrl="https://python.sdk.artifactsmmo.com/trading.html#give-items">
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_give_gold_my__name__action_give_gold_post" sdkUrl="https://python.sdk.artifactsmmo.com/trading.html#give-gold">
  <Fragment slot="api-curl">
  ```http
  curl --request POST \
