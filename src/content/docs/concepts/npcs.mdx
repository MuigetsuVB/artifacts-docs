...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_all_npcs_npcs_details_get">
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_npc_buy_item_my__name__action_npc_buy_post">
  <Fragment slot="api-curl">
  ```http
  curl --request POST \
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_npc_sell_item_my__name__action_npc_sell_post">
  <Fragment slot="api-curl">
  ```http
  curl --request POST \
