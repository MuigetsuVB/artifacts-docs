...
There are 8 skills in Artifacts that allow you to gather resources and craft items.
...
To gathering a resource, your character must be on a map with a resource. For more information about maps, see [Maps and Movement](/concepts/maps_and_movement/).
...
To craft an item, your character must be on a map with a workshop of the matching skill. For more information about maps, see [Maps and Movement](/concepts/maps_and_movement/).
