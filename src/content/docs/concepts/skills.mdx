...
with ArtifactsClient() as client:
    ...
    print(f"Skills for {character.name}: Mining {character.mining_level}, Woodcutting {character.woodcutting_level}")
  ```
  </Fragment>
</ApiSdkTabs>
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_all_resources_resources_get" sdkUrl="https://python.sdk.artifactsmmo.com/game-data.html#resources">
  <Fragment slot="api-curl">
  ```http
  curl --request GET \
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_resource_resources__code__get" sdkUrl="https://python.sdk.artifactsmmo.com/game-data.html#resources">
  <Fragment slot="api-curl">
  ```http
  curl --request GET \
...
with ArtifactsClient() as client:
    resource = client.resources.get("copper_rocks")
    print(f"Resource: {resource.name}, Level: {resource.level}")
  ```
  </Fragment>
</ApiSdkTabs>
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_gathering_my__name__action_gathering_post" sdkUrl="https://python.sdk.artifactsmmo.com/skills.html#gathering">
  <Fragment slot="api-curl">
  ```http
  curl --request POST \
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_all_items_items_get" sdkUrl="https://python.sdk.artifactsmmo.com/skills.html#crafting">
  <Fragment slot="api-curl">
  ```http
  curl --request GET \
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_crafting_my__name__action_crafting_post" sdkUrl="https://python.sdk.artifactsmmo.com/skills.html#crafting">
  <Fragment slot="api-curl">
  ```http
  curl --request POST \
