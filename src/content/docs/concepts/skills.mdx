...
**XP Base** (XP_base) by Resource Level:<br/>
- Level < 10 → 5
- Level 10-19 → 10
- Level 20-29 → 13
- Level 30-34 → 16
...
**XP Base** (XP_base) by Item Level:<br/>
- Level < 5 → 50
- Level 5-9 → 100
- Level 10-14 → 200
- Level 15-19 → 325
...
**Coefficient** by Item Level (used in the calculation):<br/>
- Level < 5 → 25
- Level 5-9 → 30
- Level 10-14 → 35
- Level 15-19 → 40
...
**Skill Multiplier** (skill_multiplier) by Craft Type:<br/>
