...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_all_events_events_get">
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_all_active_events_events_active_get">
  <Fragment slot="api-curl">
  ```http
  curl --request GET \
