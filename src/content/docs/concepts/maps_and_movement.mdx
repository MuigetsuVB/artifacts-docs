...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_all_maps_maps_get" sdkUrl="https://python.sdk.artifactsmmo.com/game-data.html#maps">
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_layer_maps_maps__layer__get" sdkUrl="https://python.sdk.artifactsmmo.com/game-data.html#maps">
  <Fragment slot="api-curl">
  ```http
  curl --request GET \
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_map_by_position_maps__layer___x___y__get" sdkUrl="https://python.sdk.artifactsmmo.com/game-data.html#maps">
  <Fragment slot="api-curl">
  ```http
  curl --request GET \
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_map_by_id_maps_id__map_id__get" sdkUrl="https://python.sdk.artifactsmmo.com/game-data.html#maps">
  <Fragment slot="api-curl">
  ```http
  curl --request GET \
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_move_my__name__action_move_post" sdkUrl="https://python.sdk.artifactsmmo.com/character.html#movement">
  <Fragment slot="api-curl">
  ```http
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_transition_my__name__action_transition_post" sdkUrl="https://python.sdk.artifactsmmo.com/character.html#movement">
  <Fragment slot="api-curl">
  ```http
