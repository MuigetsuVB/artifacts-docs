...
fetch("https://api.artifactsmmo.com/my/YOUR_CHARACTER_NAME/action/move", requestOptions)
...
fetch("https://api.artifactsmmo.com/my/YOUR_CHARACTER_NAME/action/transition", requestOptions)
   .then(response => response.text())
   .then(result => console.log(result))
   .catch(error => console.log('error', error));
  ```
