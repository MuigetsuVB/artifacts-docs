...
Retrieve maps with:
- All maps: [GET `/maps`](https://api.artifactsmmo.com/docs/#/operations/get_all_maps_maps_get)
- Filter by layer: [GET `/maps/{layer}`](https://api.artifactsmmo.com/docs/#/operations/get_layer_maps_maps__layer__get)
...
- [Skills](/concepts/skills/) — Gathering and crafting on resource and workshop maps
- [Equipment & Items](/concepts/equipment_and_items/) — Items and gear used across the world
- [Actions & Cooldowns](/concepts/actions/) — All available character actions
- [Game Data](/data/game_data/) — Browse all maps, resources, and monsters
