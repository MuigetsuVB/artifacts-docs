...
[View API Reference](https://api.artifactsmmo.com/docs/#/operations/get_server_details__get)
...
[View API Reference](https://api.artifactsmmo.com/docs/#/operations/get_all_badges_badges_get)
