...
When you complete an achievement, you earn items rewards that are sent to your [pending items](/concepts/characters-and-account/#pending-items). You can claim them with any character on your account.
...
You can also view them on the [website](https://www.artifactsmmo.com/encyclopedia/achievements) or the [API Reference](https://api.artifactsmmo.com/docs/#/operations/get_all_achievements_achievements_get).
