...
When you complete an achievement, you earn rewards that are sent to your [pending items](/concepts/characters-and-account/#pending-items). You can claim them with any character on your account.
...
View all achievements using [this endpoint](https://api.artifactsmmo.com/docs/#/operations/get_all_achievements_achievements_get) or on our [website](https://www.artifactsmmo.com/encyclopedia/achievements).