...
You can also view the complete list ofachievements using [this endpoint](https://api.artifactsmmo.com/docs/#/operations/get_all_achievements_achievements_get) or on our [website](https://www.artifactsmmo.com/encyclopedia/achievements).
