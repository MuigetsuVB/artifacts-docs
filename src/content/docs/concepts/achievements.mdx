...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_account_achievements_accounts__account__achievements_get" sdkUrl="https://python.sdk.artifactsmmo.com/account.html#account-achievements">
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_all_achievements_achievements_get" sdkUrl="https://python.sdk.artifactsmmo.com/game-data.html#achievements">
  <Fragment slot="api-curl">
  ```http
