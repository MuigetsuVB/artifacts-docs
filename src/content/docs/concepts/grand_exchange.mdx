...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_ge_sell_orders_grandexchange_orders_get">
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_ge_sell_history_grandexchange_history__code__get">
  <Fragment slot="api-curl">
  ```http
  curl --request GET \
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_ge_create_sell_order_my__name__action_grandexchange_sell_post">
  <Fragment slot="api-curl">
  ```http
  curl --request POST \
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_ge_fill_buy_order_my__name__action_grandexchange_fill_post">
  <Fragment slot="api-curl">
  ```http
  curl --request POST \
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_ge_cancel_sell_order_my__name__action_grandexchange_cancel_post">
  <Fragment slot="api-curl">
  ```http
  curl --request POST \
