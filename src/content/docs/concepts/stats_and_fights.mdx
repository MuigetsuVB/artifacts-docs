...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_all_monsters_monsters_get" sdkUrl="https://python.sdk.artifactsmmo.com/game-data.html#monsters">
  <Fragment slot="api-curl">
  ```http
  curl --request GET \
...
with ArtifactsClient() as client:
    monsters = client.monsters.get_all(page=1, size=50)
    for monster in monsters.data:
        print(f"[{monster.code}] {monster.name} - HP: {monster.hp}")
  ```
  </Fragment>
</ApiSdkTabs>
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_monster_monsters__code__get" sdkUrl="https://python.sdk.artifactsmmo.com/game-data.html#monsters">
  <Fragment slot="api-curl">
  ```http
  curl --request GET \
...
with ArtifactsClient() as client:
    monster = client.monsters.get("red_slime")
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_fight_my__name__action_fight_post" sdkUrl="https://python.sdk.artifactsmmo.com/character.html#combat">
  <Fragment slot="api-curl">
  ```http
  curl --request POST \
