...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/get_all_items_items_get" sdkUrl="https://python.sdk.artifactsmmo.com/game-data.html#items">
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_equip_item_my__name__action_equip_post" sdkUrl="https://python.sdk.artifactsmmo.com/equipment.html#equip-an-item">
  <Fragment slot="api-curl">
  ```http
  curl --request POST \
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_unequip_item_my__name__action_unequip_post" sdkUrl="https://python.sdk.artifactsmmo.com/equipment.html#unequip-an-item">
  <Fragment slot="api-curl">
  ```http
  curl --request POST \
