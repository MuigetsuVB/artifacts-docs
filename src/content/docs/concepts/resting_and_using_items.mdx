...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_rest_my__name__action_rest_post" sdkUrl="https://python.sdk.artifactsmmo.com/character.html#rest">
...
<ApiSdkTabs apiUrl="https://api.artifactsmmo.com/docs/#/operations/action_use_item_my__name__action_use_post" sdkUrl="https://python.sdk.artifactsmmo.com/inventory.html#use-an-item">
  <Fragment slot="api-curl">
  ```http
  curl --request POST \
